...
/**
 * TODO these tests are brittle. They depend on the values of MAX_DEGREE and MIN_DEGREE being 3 and
 * 1, respectively, in the HRPlusTree implementation.
 * 
 */
public class HRPlusTreePartitionTest {
    ...
    public void testUniformNonOverlappingNodes() {
        ...
        sortedNodes.add(nodeA);
        sortedNodes.add(nodeB);
        sortedNodes.add(nodeC);
        sortedNodes.add(nodeD);
    ...
    public void testNonIntersectingLine() {
        ...
        HRPlusNode nodeA = new HRPlusNode(new ObjectId(), new Envelope(-8, -6, -2, 2),
                new ObjectId());
        HRPlusNode nodeB = new HRPlusNode(new ObjectId(), new Envelope(-5, -3, -8, 4),
                new ObjectId());
        HRPlusNode nodeC = new HRPlusNode(new ObjectId(), new Envelope(-2, 0, -1, 0),
                new ObjectId());
    ...
    public void testIntersectingLine() {
        ...
        HRPlusNode nodeA = new HRPlusNode(new ObjectId(), new Envelope(-8, -6, -2, 2),
                new ObjectId());
        HRPlusNode nodeB = new HRPlusNode(new ObjectId(), new Envelope(-7, -1, -8, 4),
                new ObjectId());
        HRPlusNode nodeC = new HRPlusNode(new ObjectId(), new Envelope(-2, 2, -1, 0),
                new ObjectId());
        HRPlusNode nodeD = new HRPlusNode(new ObjectId(), new Envelope(1, 4, 0, 8), new ObjectId());
    ...
    public void testThreeOverlappingSquares() {
        ...
        HRPlusNode nodeB = new HRPlusNode(ObjectId.forString("B"), new Envelope(-9, -7, 5, 7),
                new ObjectId());
        HRPlusNode nodeC = new HRPlusNode(ObjectId.forString("C"), new Envelope(-8, -6, 6, 4),
                new ObjectId());
        HRPlusNode nodeD = new HRPlusNode(ObjectId.forString("D"), new Envelope(9, 7, -5, -7),
                new ObjectId());
