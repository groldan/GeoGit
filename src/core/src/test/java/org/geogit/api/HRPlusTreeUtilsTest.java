...
public class HRPlusTreeUtilsTest {
    ...
    public void testGetTotalAreaOfTwoRegions() {
        ...
        assertEquals(g1Area + g2Area, HRPlusTreeUtils.getTotalAreaOfTwoRegions(group1, group2),
                DOUBLE_EPSILON);
    }
    ...
    public void testPartitionByMinOverlap() {
        ...
        HRPlusNode a1 = new HRPlusNode(new ObjectId(), new Envelope(-12, -10, -2, 2),
                new ObjectId());
        HRPlusNode a2 = new HRPlusNode(new ObjectId(), new Envelope(-8, -6, -2, 2), new ObjectId());
        HRPlusNode a3 = new HRPlusNode(new ObjectId(), new Envelope(-4, -2, -2, 2), new ObjectId());
        HRPlusNode a4 = new HRPlusNode(new ObjectId(), new Envelope(2, 4, -2, 2), new ObjectId());
        ...
        assertEquals(result, HRPlusTreeUtils.partitionByMinOverlap(HRPlusTreeUtils.minXSort(nodes),
                HRPlusTreeUtils.maxXSort(nodes)));
        assertEquals(result, HRPlusTreeUtils.partitionByMinOverlap(HRPlusTreeUtils.minYSort(nodes),
        ...
        HRPlusNode b1 = new HRPlusNode(new ObjectId(), new Envelope(-12, -10, -2, 2),
                new ObjectId());
        HRPlusNode b2 = new HRPlusNode(new ObjectId(), new Envelope(-8, -6, -2, 2), new ObjectId());
        HRPlusNode b3 = new HRPlusNode(new ObjectId(), new Envelope(-4, -2, -2, 2), new ObjectId());
        HRPlusNode b4 = new HRPlusNode(new ObjectId(), new Envelope(0, 2, -2, 2), new ObjectId());
        nodes.add(b1);
        nodes.add(b2);
        nodes.add(b3);
        nodes.add(b4);
        ...
        HRPlusNode c1 = new HRPlusNode(new ObjectId(), new Envelope(-6, -4, 2, 3), new ObjectId());
        HRPlusNode c2 = new HRPlusNode(new ObjectId(), new Envelope(-3, -2, 4, 5), new ObjectId());
        HRPlusNode c3 = new HRPlusNode(new ObjectId(), new Envelope(-1, 0, 0, 1), new ObjectId());
        HRPlusNode c4 = new HRPlusNode(new ObjectId(), new Envelope(1, 2, -4, -3), new ObjectId());
        nodes.add(c1);
        nodes.add(c2);
        nodes.add(c3);
        nodes.add(c4);
        ...
        assertTrue(result.containsAll(HRPlusTreeUtils.partitionByMinOverlap(
                HRPlusTreeUtils.minXSort(nodes), HRPlusTreeUtils.maxXSort(nodes))));

        result.clear();
        result.addAll(nodes.subList(2, 4));
        assertTrue(result.containsAll(HRPlusTreeUtils.partitionByMinOverlap(
                HRPlusTreeUtils.minYSort(nodes), HRPlusTreeUtils.maxYSort(nodes))));
        result.clear();
        nodes.clear();
