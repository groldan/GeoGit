...
public class MappedObjectIndexTest extends Assert {
    ...
    public void before() throws Exception {
        ...
        platform = new TestPlatform(workingDirectory);
    ...
    public void testPutAll() {
        ...
        MappedObjectDatabase db = new MappedObjectDatabase(platform, configDB);
        db.open();
        Iterator<RevObject> objects = new AbstractIterator<RevObject>() {
            int i = 0;
