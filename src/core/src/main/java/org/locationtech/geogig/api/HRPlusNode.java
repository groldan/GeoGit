...
/**
 * Contains data within an HR+ tree. A node contains an envelope, a piece of the map. Nodes have a
 * parent container in the HR+ tree. Nodes optionally have one container as a child.
 * <p>
 * Basically, a container is used for tree organization and a node is the data in the tree that the
...
public class HRPlusNode implements RevObject {
    ...
    /**
     * Unique id for the parent of this node. This field is set by
     * {@link HRPlusContainerNode#addNode}.
     */
    ...
    /**
     * Determine whether this node is a leaf. Leaf nodes do not have a child container.
     * 
    ...
    /**
     * Bounding box query. If this node fits in container, add it to list and recurse on its child
     * (if it has a child). Else end search.
     * 
    ...
    /**
     * This method is called when this node is not a leaf node. We look at all the leaf nodes
     * pointed by its child container.
     * 
     * @return
     */
