...
class MappedObjectIndex {
    ...
    private static class MappedData {
        ...
        public MappedData(File parentDir) throws IOException {
            ...
            checkState(dataFile.exists() || dataFile.createNewFile());
        ...
        private static class ObjectSerializer {
            ...
            InternalByteArrayOutputStream out = new InternalByteArrayOutputStream(1024);

            ObjectSerializingFactory STREAMFAC = DataStreamSerializationFactoryV2.INSTANCE;
    ...
    private static class MappedIndex {
        ...
        public MappedIndex(final File parentDir) throws IOException {
            ...
            checkState(indexFile.exists() || indexFile.createNewFile());
    ...
    public MappedObjectIndex(Platform platform, ExecutorService executor) {
        ...
        this.parentDir = new File(geogigDir.get(), "revobjectindex");
    ...
    public long addAll(Iterator<RevObject> objects) {
        long count = 0;
    ...
    public RevObject find(ObjectId id) {
        // TODO Auto-generated method stub
        return null;
    }
